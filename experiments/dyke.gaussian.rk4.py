...
def plot_alphas():
    ...
    plt.title('Biotic Force of 100 species', fontsize=40)
...
def plot_alphas_truncated():
    ...
    plt.figure(figsize=(30,30))
    plt.title('Biotic Force (with Truncation) of 100 species', fontsize=40)
    plt.xlabel('Environment Condition (temperature)', fontsize=40)
    plt.ylabel('Alive Value', fontsize=40)
    plt.xticks(fontsize=20)
    plt.yticks(fontsize=20)
...
if __name__ == '__main__':
    ...
    plt.figure(figsize=(20,10))
    plt.title('Environment Variable', fontsize=40)
    plt.xlabel('Environment Condition (temperature)', fontsize=40)
    plt.ylabel('Alive Value', fontsize=40)
    myList = results[:-1]
    for item in myList:
